...
{
  background: -webkit-gradient(transparent 5px,rgba(255,255,255,.2) 6px,#2a2a2a 7px,#2a2a2a 12px,rgba(255,255,255,.2) 13px);
  background: -webkit-radial-gradient(transparent 5px,rgba(255,255,255,.2) 6px,#2a2a2a 7px,#2a2a2a 12px,rgba(255,255,255,.2) 13px);
  background: -moz-radial-gradient(transparent 5px,rgba(255,255,255,.2) 6px,#2a2a2a 7px,#2a2a2a 12px,rgba(255,255,255,.2) 13px);
  background: -ms-radial-gradient(transparent 5px,rgba(255,255,255,.2) 6px,#2a2a2a 7px,#2a2a2a 12px,rgba(255,255,255,.2) 13px);
  background: -o-radial-gradient(transparent 5px,rgba(255,255,255,.2) 6px,#2a2a2a 7px,#2a2a2a 12px,rgba(255,255,255,.2) 13px);
...
.dx-colorview-hue-scale-handle
{
  ...
  -moz-box-shadow: inset -5px 0 0 3px #2a2a2a,inset 5px 0 0 3px #2a2a2a,inset -6px 0 1px 4px rgba(255,255,255,.2),inset 6px 0 1px 4px rgba(255,255,255,.2);
...
.dx-colorview-alpha-channel-handle
{
  ...
  -moz-box-shadow: inset 0 -5px 0 3px #2a2a2a,inset 0 5px 0 3px #2a2a2a,inset 0 -6px 1px 4px rgba(255,255,255,.2),inset 0 6px 1px 4px rgba(255,255,255,.2);
...
{
  -webkit-box-shadow: 0 0 1px rgba(255,255,255,.1),0 1px 3px rgba(255,255,255,.2);
  -moz-box-shadow: 0 0 1px rgba(255,255,255,.1),0 1px 3px rgba(255,255,255,.2);
  box-shadow: 0 0 1px rgba(255,255,255,.1),0 1px 3px rgba(255,255,255,.2);
  border: 1px solid rgba(28,168,221,.5);
}
...
{
  background-color: #2a2a2a;
  -webkit-box-shadow: 0 1px 4px 0 rgba(255,255,255,.37);
  -moz-box-shadow: 0 1px 4px 0 rgba(255,255,255,.37);
...
{
  border-color: rgba(28,168,221,.4);
}
...
{
  background-color: rgba(28,168,221,.7);
  color: #2a2a2a;
}
...
.dx-list-item.dx-list-item-ghost-reordering.dx-state-focused.dx-state-hover
{
  color: #7c7c7c;
  background: #2a2a2a;
  border-top: 1px solid rgba(28,168,221,.5);
  border-bottom: 1px solid rgba(28,168,221,.5);
  -webkit-box-shadow: 0 0 1px rgba(255,255,255,.1),0 1px 3px rgba(255,255,255,.2);
  -moz-box-shadow: 0 0 1px rgba(255,255,255,.1),0 1px 3px rgba(255,255,255,.2);
  box-shadow: 0 0 1px rgba(255,255,255,.1),0 1px 3px rgba(255,255,255,.2);
}
...
.dx-list-context-menucontent
{
  ...
  -o-border-radius: 0;
  border-radius: 0;
  -webkit-box-shadow: 0 3px 10px rgba(255,255,255,.1);
  -moz-box-shadow: 0 3px 10px rgba(255,255,255,.1);
...
{
  -webkit-box-shadow: 0 1px 7px rgba(255,255,255,.16);
  -moz-box-shadow: 0 1px 7px rgba(255,255,255,.16);
  box-shadow: 0 1px 7px rgba(255,255,255,.16);
}
...
.dx-dateview-item-selected-frame:before
{
  ...
  border-bottom: 1px solid #4d4d4d;
  background-repeat: no-repeat;
  background-image: -webkit-linear-gradient(bottom,rgba(42,42,42,0) 0%,rgba(42,42,42,.8) 60%);
  background-image: -moz-linear-gradient(bottom,rgba(42,42,42,0) 0%,rgba(42,42,42,.8) 60%);
  background-image: -ms-linear-gradient(bottom,rgba(42,42,42,0) 0%,rgba(42,42,42,.8) 60%);
  background-image: -o-linear-gradient(bottom,rgba(42,42,42,0) 0%,rgba(42,42,42,.8) 60%);
}
.dx-dateview-item-selected-frame:after
{
  ...
  border-top: 1px solid #4d4d4d;
  background-repeat: no-repeat;
  background-image: -webkit-linear-gradient(top,rgba(42,42,42,0) 0%,rgba(42,42,42,.8) 60%);
  background-image: -moz-linear-gradient(top,rgba(42,42,42,0) 0%,rgba(42,42,42,.8) 60%);
  background-image: -ms-linear-gradient(top,rgba(42,42,42,0) 0%,rgba(42,42,42,.8) 60%);
  background-image: -o-linear-gradient(top,rgba(42,42,42,0) 0%,rgba(42,42,42,.8) 60%);
}
.dx-device-tablet .dx-dateview-rollers, .dx-device-phone .dx-dateview-rollers
{
  display: -webkit-box;
  display: -webkit-flex;
  display: -moz-flex;
...
.dx-device-tablet .dx-dateviewroller-month, .dx-device-phone .dx-dateviewroller-month
{
  min-width: 4em;
}
.dx-device-tablet .dx-dateview-item, .dx-device-phone .dx-dateview-item
{
  font-size: 1.1em;
}
.dx-device-tablet .dx-dateview-item-selected, .dx-device-phone .dx-dateview-item-selected
{
  font-size: 1.4em;
}
.dx-toolbar
...
{
  background-color: rgba(28,168,221,.6);
}
...
{
  background-color: rgba(28,168,221,.5);
}
...
.dx-datagrid-column-chooser .dx-overlay-content .dx-popup-content .dx-column-chooser-item
{
  ...
  border: 1px solid #4d4d4d;
  padding: 7px;
  -webkit-box-shadow: 0 1px 3px -1px rgba(255,255,255,.2);
  -moz-box-shadow: 0 1px 3px -1px rgba(255,255,255,.2);
  box-shadow: 0 1px 3px -1px rgba(255,255,255,.2);
}
...
.dx-datagrid-filter-range-overlay .dx-overlay-content
{
  border: 1px solid #4d4d4d;
  overflow: inherit;
  -webkit-box-shadow: 2px 2px 3px rgba(255,255,255,.15);
  -moz-box-shadow: 2px 2px 3px rgba(255,255,255,.15);
  box-shadow: 2px 2px 3px rgba(255,255,255,.15);
}
...
.dx-menu-item-selected, .dx-menu-item-selected.dx-state-focused, .dx-menu-item-selected.dx-state-active, .dx-menu-item-selected.dx-menu-item-expanded
{
  background-color: #1ca8dd;
  color: #2a2a2a;
}
.dx-menu-item-selected>.dx-menu-item-content .dx-icon, .dx-menu-item-selected.dx-state-focused>.dx-menu-item-content .dx-icon, .dx-menu-item-selected.dx-state-active>.dx-menu-item-content .dx-icon, .dx-menu-item-selected.dx-menu-item-expanded>.dx-menu-item-content .dx-icon
{
  color: #2a2a2a;
}
.dx-menu-base
...
.dx-context-menu .dx-submenu
{
  background-color: #2a2a2a;
  border: 1px solid #4d4d4d;
  -webkit-box-shadow: 0 2px 2px rgba(255,255,255,.15);
  -moz-box-shadow: 0 2px 2px rgba(255,255,255,.15);
  box-shadow: 0 2px 2px rgba(255,255,255,.15);
}
...
.dx-calendar-cell.dx-state-hover
{
  ...
  -moz-box-shadow: inset 0 -1px 0 1000px #343434;
...
.dx-calendar-cell.dx-calendar-selected-date, .dx-calendar-cell.dx-calendar-selected-date.dx-calendar-today
{
  ...
  -moz-box-shadow: inset 0 0 0 1000px #1ca8dd;
